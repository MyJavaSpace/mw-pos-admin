...
public class GeneratorController implements IGeneratorCode {
	final String tempName = "mw.pos.controller.txt";
	final String packageName = "com.pos.dao";
	final String methodBodyTemp = "	{returnType} {methodName}({parameterTypes});";

	public static void main(String[] args) throws FileNotFoundException {
		new GeneratorController().GeneratorCode();
		System.out.println("done!GeneratorController");
	}
	...
	public void GeneratorCode() {
		...
		for (String string : lstClass) {
			...
			serviceName=Common.toLowerCaseFirstOne(serviceName);
			...
			File file = new File(
					System.getProperty("user.dir") + "/src/main/java/mw/pos/controllers/" + ServiceName + "Controller.java");
			try {
